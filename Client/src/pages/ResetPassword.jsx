...
const ResetPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  bg-linear-to-br from-blue-200 to-purple-400">
      ...
      <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 shadow-lg w-96 text-sm rounded-md">
      ...
      <form onSubmit={onsubmitOTP} className="bg-slate-900 p-8 shadow-lg w-96 text-sm rounded-md">
        <h1 className="text-white text-2xl font-semibold text-center mb-4">
          Reset Password OTP
        </h1>
        <p className="text-center mb-6 text-indigo-300">
      ...
      {isotpSubmited && isEmailSent &&
      <form onSubmit={onsubmitNewPassword} className="bg-slate-900 p-8 shadow-lg w-96 text-sm rounded-md">
        <h1 className="text-white text-2xl font-semibold text-center mb-4">
          New Password
        </h1>
        <p className="text-center mb-6 text-indigo-300">
